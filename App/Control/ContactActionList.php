...
// 6.2 Lists
// 6.2.4 Examples
// 6.2.4.2 Lists with actions and transformers
...
class ContactActionList extends Page {
    private $datagrid;
    ...
    public function __construct() {
        ...
        $name->setTransformer([$this, 'convertToUpper']);
        
        $action1 = new DatagridAction([$this, 'onVisualize']);
        $action1->setLabel('Visualize');
        $action1->setImage('icon_view.png');
    ...
    public function convertToUpper($value) {
        return strtoupper($value);
    }
    
    public function onVisualize($param) {
        new Message('info',  'You selected the register: ' . $param['name']);
    }
